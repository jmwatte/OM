function Invoke-OMQuickFind {
    ...
    :albumSelectionLoop while ($true) {
        ...
        $albumChoice = Show-OMPrompt -Prompt "Select album [number] (Enter=first), (P)rovider, Shift+{F}indMode, (ni) New Item, (s)kip, e(x)it, (C)over {[V]iew,[O]riginal,[S]ave,saveIn[T]ags}, or new search term$modeIndicator" -Context $Context
