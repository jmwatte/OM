...
function Start-OM {
    ...
    process {
        ...
        foreach ($albumOriginal in $albums) {
            ...
            # Pagination fields removed to avoid analyzer warnings
            $albumDone = $false
                ...
                switch ($stage) {
                    ...
                    "A" {
                        ...
                        for ($i = 0; $i -lt $candidates.Count; $i++) {
                            ...
                            Show-Message -Message ("[$($i+1)] $nameToDisplay - $($candidates[$i].genres -join ', ') (id: $($candidates[$i].id))") -ForegroundColor Gray -Context $Context
                        }
